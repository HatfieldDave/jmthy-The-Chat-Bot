...
Insert INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('catch-all','So sorry, but I don''t know how to respond to that yet. | I''m still learning all the things I need to know to be the best helper Yetti I can be! | If this is an emergency please slack your pathway director or instructor.','','')
--Quotes
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('hi', 'Hi there! What can I help you with?', '', '')
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('hola','Que paso, my friend?','','');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('hi jmthy | how are you? | what wassup | what''s poppin'' | ugh | hey | yello | yo | greetings | good morrow ','Hi my friend, I''m JMTHY. John and Matt''s Tiny Helper Yetti. What''s on your mind today?','','');
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('motivational | quotes | motivational quotes','Tight, I love quotes! My quotes even come with an emotional supprt animal. Any time you need one just type "Quotes"', '','');
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('do a kick flip | do a trick','| MY | self worth | is not tied | to doing party tricks | I AM Enough | and SO ARE YOU!','','')
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('what do you think about codee| codee ','I think it''s weird to name your robot codee when you dont know how to code','', '')
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('time management | not enough hours in the day | where did the day go | I can''t get everything done ','The Pomodoro Technique: |
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('resume | resume template | resume sample ','Your resume should include all of these items, Professional Summary, Name/Contact Information, Technical Skills, Technical Experience, Education and Professional Experience.
...
--Curriculum
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('loops','Loops are a fundamental concept for managing program control flow, but they go hand in hand with arrays. Loops provide a convenient way to write a small amount of code that can iterate through all of the values in an array one by one.',
'https://www.w3schools.com/cs/cs_for_loop.php','https://www.tutorialsteacher.com/Content/images/csharp/for-loop.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('arrays','Arrays are a special data type found in almost all programming languages. They make it more convenient to work with values in aggregate rather than a series of individual variables.',
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('object oriented programing | oop','Object-Oriented Programming is about organizing your problem-solving into objects. An object is an in-memory data structure that combines state and behavior into a usable and useful abstraction. In other words, objects are a collection of variables and methods.',
'https://www.w3schools.com/cs/cs_oop.php','https://procodeguide.b-cdn.net/wp-content/uploads/2020/05/Encapsulation-1024x397.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('mvc | model view controller | model | view | controller','MVC is abbreviated as Model View Controller is a design pattern created for developing applications specifically web applications. As the name suggests, it has three major parts. The traditional software design pattern works in an "Input - Process - Output" pattern whereas MVC works as "Controller -Model - View" approach. ',
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('sql | data | database','SQL is the standard language for dealing with Relational Databases and used to insert, search, update, and delete database records.',
