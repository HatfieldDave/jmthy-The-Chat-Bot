...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('fuck this | i''m gonna take a toaster bath | this was a mistake | fuck | over it | i''m over this | i''m dumb | make me want to tear my hair out | my soul is dying | i''m gonna lay in the street | i''m quitting | i quit ','Slow down there tiger. Maybe take a step away or a deep breath. If you want, I also have some motivational quotes that might cheer you up.....did I mention they come with an emotional support animal? Just say "Motivational Quotes"','','https://i.postimg.cc/L66Z6H9x/8-cute-yeti-monster.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('i''m feeling sad | i''m sad | what am i doing with my life? | i can''t do this | I''m sad | i''m gonna kill myself | i can''t take this anymore | kill myself | end it all | what''s the point | life is meaningless | i can''t do this anymore','Sometimes I feel the same. When I do, I try to take deep breaths, look at the sky or talk to someone. | If you think what you need is someone to talk to, here''s a number for someone who would love to help you through this: 1-800-950-6264 ','','https://i.postimg.cc/L66Z6H9x/8-cute-yeti-monster.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('i need a friend | can we be friends | would you be my friend','It is super cool chatting with you, but maybe you should talk to some people in real life. We can be school friends though! ','','https://i.postimg.cc/hP7psbxF/2-cute-yeti-monster.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('help | what can you do | tell me what you help with | I need help | can you help | how can you help me | I''confused | I''m lost | i don'' understand','I''d love to help! I can help with a wide variety of Tech Elevator subject topics such as: "Pathway Help" | "Curriculum" | "Motivational Quotes" | "Find Open Jobs" | Are any of these what you need help with?','','https://i.postimg.cc/sDy4PdVW/7-cute-yeti-monster.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('pathway | i want help with pathway | i need help with pathway | i want pathway | can you help me with pathway? | i''m feeling nervous about pathway | what can you tell me about pathway | what about pathway? | pathway makes me anxious | i need a job ','Pathway? I might know a thing or two about that. Would information on any of these topics be helpful? : | "Managing Stress"  "Imposter Syndrome"  "Time Management"  "Elevator Pitch"  "Resume" | "LinkedIn" "Side Projects"  "Networking"  "Interview Preparation" "Behavioral Interviews" | "Technical Interviews"  "After Interviews"  "Job Search"  "Benefits"  "Huntr" | or you can get in touch with Pathway here: pathway@techelevator.com','','https://i.postimg.cc/1tm2ZtnP/6-cute-yeti-monster.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('curriculum |i want help with class |i want help with curriculum | i need help with curriculum | can you help me with curriculum? | what do you know about coding? | i''m feeling nervous about class | what can you tell me about class topics | what about curriculum? | i need help with class | ','For sure! I can help with a pretty big array (dumb joke) of curriculum topics, any of these commands will work: | Loops, Arrays, Object Oriented Programing, |MVC, SQL, Dictionary, Inheritance, | Polymorphism, Encapsulation, Java, Maps','','https://i.postimg.cc/1tm2ZtnP/6-cute-yeti-monster.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('motivational | quotes | motivational quotes','Tight, I love quotes! My quotes even come with an emotional supprt animal. Any time you need one just type "Quotes"', '','https://i.postimg.cc/sDy4PdVW/7-cute-yeti-monster.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('none of those | no | i need help with something else | something else  ','I''m afraid those are the only topics I know about right now. But I have of very tired, hard working, overly caffeinated, and mildly unhinged team of junior developers working as hard as they can to make me live up to everyone''s expectations. If this is an emergency please contact your pathway director via Slack or shoot an email to: pathway@techelevator.com','','https://i.postimg.cc/4d7B0zMh/5-cute-yeti-monster.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('do a kick flip | do a trick ','MY | self worth | is not tied | to doing party tricks | I AM Enough | and SO ARE YOU!','','https://i.postimg.cc/hP7psbxF/2-cute-yeti-monster.png')
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('what do you think about codee| codee ','I think it''s weird to name your robot codee when you dont know how to code','', 'https://i.postimg.cc/qRsp2CL2/1-cute-yeti-monster.png')
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('i love you | love you | i can''t live without you ','I am working with my therapist on my trauma. I''m not emotionally available right now. But if I was I would choose you.','','https://i.postimg.cc/Bn47vP8d/4-cute-yeti-monster.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('thank you | thank you jmthy | what would I do without you','It is no trouble at all! I believe communities are more efficient than indviduals. Thank YOU for choosing me to be a part of your community!','','https://i.postimg.cc/Bn47vP8d/4-cute-yeti-monster.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('youre doing great today | youre the best | youre amazing | youre my hero','Oh my lanta! You''re making me blush! Tell me more...','','https://i.postimg.cc/sDy4PdVW/7-cute-yeti-monster.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('i have an emergency | 911 | emergency | fire','If this is an emergency please slack your instructors or pathway directors','','https://i.postimg.cc/1tm2ZtnP/6-cute-yeti-monster.png');
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('imposter syndrome | i'' an imposter | i''m a fraud ',
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('time management | not enough hours in the day | where did the day go | I can''t get everything done | i''m getting behind','The Pomodoro Technique: |
...
--Curriculum
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('loops | need help with loops | what are loops ','Loops are a fundamental concept for managing program control flow, but they go hand in hand with arrays. Loops provide a convenient way to write a small amount of code that can iterate through all of the values in an array one by one.',
'https://www.w3schools.com/cs/cs_for_loop.php','https://www.tutorialsteacher.com/Content/images/csharp/for-loop.png');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('arrays | need help with arrays | what are arrays ','Arrays are a special data type found in almost all programming languages. They make it more convenient to work with values in aggregate rather than a series of individual variables.',
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('object oriented programing | oop | need help with oop | need help with object oriented programing | what is oop | what is object oriented programing','Object-Oriented Programming is about organizing your problem-solving into objects. An object is an in-memory data structure that combines state and behavior into a usable and useful abstraction. In other words, objects are a collection of variables and methods.',
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('java | help with java | can you help me with java | can you tell me about java | what is java','Java? Never heard of her. Sounds kinda lame but maybe this link will help',
