...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('what do you think about codee | codee ','I think it''s weird to name your robot codee when you dont know how to code','', 'https://i.postimg.cc/0NcfRmbf/1-gimthy.gif')
...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('matt | matt eland | batman | .net | net','Matt is awesome','https://www.youtube.com/watch?v=H_0Hm8KZlk0','');
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('john | john fulton | sweet sweet angel | .net | net','John is awesome','https://www.youtube.com/watch?v=4CVbuBwbDIM','');
