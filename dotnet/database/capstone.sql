...
INSERT INTO topic (topic_q, topic_info, info_link, img_link) VALUES ('motivational | quotes','Tight, I love quotes! My quotes even come with an emotional supprt animal. Any time you need one just type "Quotes"', '','');
